...
<html lang="en">
  ...
  <div class="container">
    ...
    <section class="menu">
		...
		// Trial Period
			$trial = $_POST['trial'];
			$trialCycles = $_POST['trial-cyles-good'];

		// Add-ons
			$addOn = $_POST['add-on'];
			$addOnCycles = $_POST['add-on-cyles-good'];

		// Discounts
		  $discount = $_POST['discount'];
		  $discountCycles = $_POST['discount-cyles-good'];
    	...
    	<?php if ($result->success): ?>
      	<h3>Success!</h3>
      	<p>Subscription ID is <?php echo($result->subscription->id)?>. <?php echo($result->subscription->transactions[0]->amount)?> has been charged up front.</p>
